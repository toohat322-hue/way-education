...
export const UNIVERSITIES = [
  ...
  },
  {
    ...
    grad: grad.card2,
    initial: "H",
    image: "/universities/heroes/ihu-real.jpg",
    logo: "/universities/logos/ihu.svg",
    gallery: [],
    photoCredit: {
      text: "Photo: YG01 / Wikimedia Commons (CC BY 4.0)",
      url: "https://commons.wikimedia.org/wiki/File:Istanbul_Health_and_Technology_University.jpg",
    },
    name: "Istanbul Health & Tech University",
    city: { en: "Istanbul", ar: "إسطنبول" },
    country: { en: "Türkiye", ar: "تركيا" },
    type: { en: "Private", ar: "خاصة" },
    tuition: 4000,
    ...
    testimonials: [
      {
        name: "Ahmed, Morocco",
        text: {
          en: "The dentistry labs are better than I imagined.",
          ar: "مختبرات طب الأسنان أفضل مما تخيلت.",
        },
        rating: 5,
      },
    ],
  },
  {
    ...
    grad: grad.card3,
    initial: "Y",
    image: "/universities/heroes/aybu.svg",
    logo: "/universities/logos/aybu.svg",
    gallery: [],
    name: "Ankara Yıldırım Beyazıt University",
    city: { en: "Ankara", ar: "أنقرة" },
    country: { en: "Türkiye", ar: "تركيا" },
    type: { en: "Public", ar: "حكومية" },
    tuition: 1800,
    rating: 4.5,
    reviews: 260,
    ranking: 9,
    ...
    intl: "3,000+",
    language: { en: "Turkish / English", ar: "تركي / إنجليزي" },
    scholarship: 100,
    majors: [
      {
    ...
    testimonials: [
      {
        name: "Salma, Algeria",
        text: {
          en: "Full scholarship changed my family's life.",
          ar: "المنحة الكاملة غيّرت حياة عائلتي.",
        },
        rating: 5,
      },
    ],
...

  {
    ...
    grad: grad.card1,
    initial: "G",
    image: "/universities/heroes/gau-real.jpg",
    logo: "/universities/logos/gau.svg",
    gallery: [],
    name: "Girne American University",
    city: { en: "Kyrenia", ar: "كيرينيا" },
    country: { en: "N. Cyprus", ar: "قبرص الشمالية" },
    type: { en: "Private", ar: "خاصة" },
    tuition: 3000,
    rating: 4.4,
    reviews: 175,
    ...
    testimonials: [
      {
        name: "Omar, Tunisia",
        text: {
          en: "Studying by the sea while building my career — dream setup.",
          ar: "أدرس بجانب البحر وأبني مستقبلي — إعداد أحلامي.",
        },
        rating: 4,
      },
    ],
