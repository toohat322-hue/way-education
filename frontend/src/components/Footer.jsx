  ...
  return (
    <footer className="pt-14 pb-8 mt-8" style={{ background: "#0B1230" }}>
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div
          className="flex flex-wrap items-start justify-between gap-x-10 gap-y-8 mb-10 pb-10"
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3">
            <span
              ...
              style={{ color: "rgba(255,255,255,0.65)" }}
            >
              <Phone size={14} /> <bdi>+90 (501) 600 00 33</bdi>
            </span>
            <span
              className="flex items-center gap-2 text-sm whitespace-nowrap"
              style={{ color: "rgba(255,255,255,0.65)" }}
            >
              <Mail size={14} /> contact@wayeducations.com
            </span>
            <span
              className="flex items-center gap-2 text-sm whitespace-nowrap"
              style={{ color: "rgba(255,255,255,0.65)" }}
            >
              <MapPin size={14} /> Istanbul, Türkiye
            </span>
            <a
              href="https://www.instagram.com/way.education.tr/"
              target="_blank"
