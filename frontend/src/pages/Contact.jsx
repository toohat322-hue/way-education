    ...
    <div className="max-w-4xl mx-auto px-5 sm:px-8 py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          {[
            [Phone, settings?.supportPhone || "+90 (501) 600 00 33"],
            [Mail, settings?.supportEmail || "hello@wayeducation.com"],
            [MapPin, settings?.addressEn || "Istanbul, Türkiye"],
          ].map(([Icon, label], i) => (
            <GlassCard
              key={i}
            ...
            >
              ...
              <span className="text-sm font-medium" style={{ color: C.ink }}>
                {Icon === Phone ? <bdi>{label}</bdi> : label}
              </span>
            </GlassCard>
          ))}
          <a
