            ...
            <GlassCard key={key} className="p-4" style={{ background: "#fff" }}>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {isArray ? (
                  ...
                  <>
                    <TextInput value={strings.en[key]} onChange={(e) => updateString("en", key, e.target.value)} />
                    <TextInput dir="rtl" value={strings.ar[key] || ""} onChange={(e) => updateString("ar", key, e.target.value)} />
                  </>
                )}
              </div>
            </GlassCard>
