  ...
  return (
    <AdminModal title={faq ? "Edit FAQ" : "Add FAQ"} onClose={guardedClose}>
      <form onSubmit={handleSubmit} className="space-y-4">
        <Field label="Question (English)"><TextArea rows={2} required value={form.qEn} onChange={set("qEn")} /></Field>
        <Field label="Question (Arabic)"><TextArea rows={2} required value={form.qAr} onChange={set("qAr")} dir="rtl" /></Field>
        <Field label="Answer (English)"><TextArea rows={3} required value={form.aEn} onChange={set("aEn")} /></Field>
        <Field label="Answer (Arabic)"><TextArea rows={3} required value={form.aAr} onChange={set("aAr")} dir="rtl" /></Field>
...
export default function AdminFaqs() {
  const { faqs, removeFaq, resetFaqs } = useData();
  const showToast = useToast();
